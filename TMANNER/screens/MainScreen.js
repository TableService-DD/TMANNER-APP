      ...
      <View style={styles.container}>
        ...
        <View style={styles.monthSalesContainer}>
          ...
          <View style={styles.priceMonthContainer}>
            ...
            <View style={styles.logobox}>
              <Image
                source={require("../assets/source/nextBtn.png")}
        ...
        <View style={styles.MenuMangeContainer}>
          ...
          <View style={styles.MenuBtnContainer}>
            <TouchableOpacity
              style={styles.btn}
              onPress={() => navigation.navigate("SoldOut")}
            >
            ...
            >
              ...
              <Text style={styles.btnSubTitle}>
                주문함과 동시에 고객들에게 서비스 제공이 가능해요
              </Text>
              <Text style={styles.btnIcon}>🙌🏾</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.btn}
              onPress={() => navigation.navigate("FastRequestManage")}
            >
              <Text style={styles.btnTitle}>빠른 요청 서비스 관리</Text>
              <Text style={styles.btnSubTitle}>간단하게 요청</Text>
              <Text style={styles.btnIcon}>👋🏻</Text>
            </TouchableOpacity>
          </View>
        </View>
